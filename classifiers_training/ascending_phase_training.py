...
folder_paths_train = {
    "Ascending error: Rounded lower back (lumbar spine). Maintain a neutral spine to avoid injury.": "../processed_videos/train/Ascending error: Rounded lower back (lumbar spine). Maintain a neutral spine to avoid injury.",
    "Ascending error: The barbell is drifting away from the body. Keep it close to your shins.": "../processed_videos/train/Ascending error: The barbell is drifting away from the body. Keep it close to your shins.", 
    "Ascending phase is correct": "../processed_videos/train/Ascending phase is correct", 
}

folder_paths_test = {
    "Ascending error: Rounded lower back (lumbar spine). Maintain a neutral spine to avoid injury.": "../processed_videos/test/Ascending error: Rounded lower back (lumbar spine). Maintain a neutral spine to avoid injury.",
    "Ascending error: The barbell is drifting away from the body. Keep it close to your shins.": "../processed_videos/test/Ascending error: The barbell is drifting away from the body. Keep it close to your shins.", 
    "Ascending phase is correct": "../processed_videos/test/Ascending phase is correct", 
}
...
best_accuracy = 0.0  
best_model_path = "best_deadlift_descending_phase_classifier.pth"
best_loss = 1000000
