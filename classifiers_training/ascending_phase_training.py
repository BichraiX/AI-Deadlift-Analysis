...
folder_paths = {
    "Ascending error: Rounded lower back (lumbar spine). Maintain a neutral spine to avoid injury.": "/users/eleves-a/2022/amine.chraibi/AI-Deadlift-Analysis/processed_videos/Ascending error: Rounded lower back (lumbar spine). Maintain a neutral spine to avoid injury.",
    "Ascending error: The barbell is drifting away from the body. Keep it close to your shins.": "/users/eleves-a/2022/amine.chraibi/AI-Deadlift-Analysis/processed_videos/Ascending error: The barbell is drifting away from the body. Keep it close to your shins.", 
    "Ascending phase is correct": "/users/eleves-a/2022/amine.chraibi/AI-Deadlift-Analysis/processed_videos/Ascending phase is correct", 
}
...
best_model_path = "best_deadlift_ascending_phase_classifier.pth"
best_loss = 1000000
# Training loop
