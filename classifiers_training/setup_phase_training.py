...
folder_paths_train = {
    "Setup error: Hips are too low (like a squat)": "../processed_videos/train/Setup error: Hips are too low (like a squat)",
    "Setup error: Rounded upper back (thoracic spine). Maintain a neutral spine.": "../processed_videos/train/Setup error: Rounded upper back (thoracic spine). Maintain a neutral spine.", 
    "Setup phase is correct.": "../processed_videos/train/Setup phase is correct.", 
}

folder_paths_train = {
    "Setup error: Hips are too low (like a squat)": "../processed_videos/test/Setup error: Hips are too low (like a squat)",
    "Setup error: Rounded upper back (thoracic spine). Maintain a neutral spine.": "../processed_videos/test/Setup error: Rounded upper back (thoracic spine). Maintain a neutral spine.", 
    "Setup phase is correct.": "../processed_videos/test/Setup phase is correct.", 
}
