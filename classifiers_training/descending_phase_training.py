...
folder_paths_train = {
    "Descending error: Barbell is drifting away from the legs. Keep it close to your shins": "../processed_videos/train/Descending error: Barbell is drifting away from the legs. Keep it close to your shins",
    "Descending error: Rounded lower back. Maintain a neutral spine during the descent.": "../processed_videos/train/Descending error: Rounded lower back. Maintain a neutral spine during the descent.", 
    "Descending phase is correct": "../processed_videos/train/Descending phase is correct", 
}

folder_paths_test = {
    "Descending error: Barbell is drifting away from the legs. Keep it close to your shins": "../processed_videos/test/Descending error: Barbell is drifting away from the legs. Keep it close to your shins",
    "Descending error: Rounded lower back. Maintain a neutral spine during the descent.": "../processed_videos/test/Descending error: Rounded lower back. Maintain a neutral spine during the descent.", 
    "Descending phase is correct": "../processed_videos/test/Descending phase is correct", 
}
