...
folder_paths = {
    "Descending error: Barbell is drifting away from the legs. Keep it close to your shins": "/users/eleves-a/2022/amine.chraibi/AI-Deadlift-Analysis/processed_videos/Descending error: Barbell is drifting away from the legs. Keep it close to your shins",
    "Descending error: Rounded lower back. Maintain a neutral spine during the descent.": "/users/eleves-a/2022/amine.chraibi/AI-Deadlift-Analysis/processed_videos/Descending error: Rounded lower back. Maintain a neutral spine during the descent.", 
    "Descending phase is correct": "/users/eleves-a/2022/amine.chraibi/AI-Deadlift-Analysis/processed_videos/Descending phase is correct", 
}
